...
1. How do formulary restrictions vary across NYC Medicaid MCOs?

2. Which neighborhoods experience the greatest barriers to medication access?

3. How do disease burden and payer policies interact to influence treatment accessibility?

---

## Data Sources

- NY Medicaid MCO Formularies
- CMS Data
- US Census ACS
...
1. Collect Medicaid formulary data

2. Benchmark utilization management policies

3. Create Access Gap Index

4. Map disparities across NYC ZIP codes
